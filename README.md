...
If you've written a formatter for the language which is not supported by current version of Localized Carbon out of the box - feel free to make a pull request with it in the current version branch (1.1), but be sure to adjust your formatter for been used by the package.
